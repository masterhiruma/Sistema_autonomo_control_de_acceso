...
# Determinar la ubicación de la carpeta de reportes
...
CARPETA_REPORTES = os.path.join(application_path, "reportes_acceso")
ARCHIVO_ESTADO_DIARIO = os.path.join(application_path, "estado_diario.json")
...
# --- Importar Constantes ---
# Asumimos que constants.py existe y tiene las definiciones necesarias
try:
    import constants
except ImportError:
    print("ADVERTENCIA: constants.py no encontrado en reporting_logging.py. Usando valores placeholder.")
    class constants: # Placeholder si constants.py no está listo
        ARCHIVO_ESTADO_DIARIO = "estado_diario_fallback.json"
        CARPETA_REPORTES = "reportes_fallback"
        MAX_INTENTOS_FALLIDOS_UID = 3
        TIEMPO_BLOQUEO_UID_NIVEL = {1: 30, 2: 60, 3: 120}
        TIEMPO_COOLDOWN_ACCESO_S = 300
