                        ...
                        if len(partes) == 7: 
                            with lock_datos_hardware:
                                try:
                                    ...
                                    # ¡NUEVO! Poner los datos en la cola para la GUI
                                    if ui_queue:
                                        ui_queue.put({
                                            "type": "hw_update",
                                            "data": datos_hardware.copy()
                                        })
...
def desconectar_arduino_emergencia():
    ...
    # AVISAR A LA GUI DE LA DESCONEXIÓN DE EMERGENCIA
    if ui_queue:
        ui_queue.put({
            "type": "desconexion_emergencia",
            "mensaje": "Error de comunicación. Desconectado."
        })
